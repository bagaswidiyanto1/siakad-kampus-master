                        ...
                        foreach ($fakultas as $key => $value) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit<?= $value['id_fakultas'] ?>"><i class="fa fa-edit"></i></button>
    ...
    <div class="modal fade" id="edit<?= $value['id_fakultas'] ?>">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('fakultas/edit/' . $value['id_fakultas']); ?>
                    <div class="form-group">
                        <label> Fakultas</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <h3>Apakah Anda Ingin Menghapus Fakultas</h3>
                    <h4 class="text-red"><b><?= $value['fakultas']; ?></b></h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger pull-left btn-flet" data-dismiss="modal">Close</button>
                    <a href="<?= base_url('fakultas/delete_data/' . $value['id_fakultas']); ?>" class="btn btn-success btn-flat">Simpan</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
